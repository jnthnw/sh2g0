    ...
    <div class="container">
      ...
      <div class="text">
        ...
        <p>
          ...
          our own content on these web pages. responsibility for the content of
          external links lies solely with the operators of the linked pages.
        ...
        <p></p>
        <h2>DATENSCHUTZERKLÄRUNG Datenschutz</h2>
        <p>
